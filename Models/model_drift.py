...
YOUR_PROJECT_NAME = "MLOPS Project"
YOUR_PROJECT_DESCRIPTION = "Sepsis Prediction"
...
def create_report(i: int):
    data_drift_report = Report(
        metrics=[
            ...
            ColumnDriftMetric(column_name="HR", stattest="wasserstein"),
            ColumnSummaryMetric(column_name="HR"),
        ],
        timestamp=datetime.datetime.now() + datetime.timedelta(days=i),
    )
 
    data_drift_report.run(reference_data=a, current_data=b.iloc[100 * i : 100 * (i + 1), :])
...
def create_test_suite(i: int):
    ...
    data_drift_test_suite.run(reference_data=a, current_data=b.iloc[100 * i : 100 * (i + 1), :])
